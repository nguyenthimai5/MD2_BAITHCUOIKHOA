...
public class Authors implements IBook{
    ...
    public Authors(int authorId, String authorName, boolean authorStatus) {
    ...
    public void insertData(Object object) {
        ...
        try {
            ...
            oos.writeObject((List<Authors>) object);
        } catch (Exception ex) {
            ex.printStackTrace();
        } finally {
            try {
    ...
    public void getData(List<Authors> listAuthor, List<Book> listBook) {
        ...
        try {
            ...
            if (file.exists()) {
                ...
                List<Authors> listRead = (List<Authors>) ois.readObject();
